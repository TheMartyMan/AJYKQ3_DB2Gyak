...
public class UjFilm extends JDialog {
	...
	public UjFilm(JFrame f) {
		...
		{
			JLabel lblEladottjegyek = new JLabel("Hozz\u00E1rendelt Vev\u0151 ID:");
			lblEladottjegyek.setFont(new Font("Tahoma", Font.PLAIN, 14));
			lblEladottjegyek.setBounds(10, 154, 149, 26);
			contentPanel.add(lblEladottjegyek);
		}
		{
	...
	public void uzenet(String msg) {
		JOptionPane.showMessageDialog(null, msg, "Hiba Üzenet", 2);
	}
