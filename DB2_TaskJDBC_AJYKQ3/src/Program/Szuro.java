...
public class Szuro extends JDialog {
	...
	private JTextField vevonev;
	private JButton btnBezar;
	private JButton btnSzures;
	private JButton btnSzures2;
	private JButton btnSzures3;
	private JButton btnSzures4;
	private JButton btnSzures5;
	...
	public Szuro() {
		...
		Object sz3tmn[] = {"Jel","Kód","Filmcím","Rendezõ","Megjelenés dátuma","Eladott jegyek"};
		sz3tm = new Szuro3TM(sz3tmn, 0);
		
		Object sz4tmn[] = {"Jel","Kód","Filmcím","Rendezõ","Megjelenés dátuma","Eladott jegyek"};
